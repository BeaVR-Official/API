...
/**
* @api {post} /comments/:idApp Publier un commentaire
* @apiVersion 1.0.0
...
/**
* @api {put} /comments/:idComment Modifier un commentaire
* @apiVersion 1.0.0
* @apiName Modifier un commentaire
* @apiGroup Gestion Commentaires
* @apiDescription Modifier un commentaire sur une application.
*
* @apiParam {String} comment Commentaire de l'utilisateur
* @apiParam {Number} rating Note donnée par l'utilisateur à l'application
* @apiParam {Number} application ID de l'application
...
/**
* @api {get} /comments/:idApp/:limit Liste des commentaires d'une application
* @apiVersion 1.0.0
* @apiName Liste des commentaires d'une application
* @apiGroup Gestion Commentaires
* @apiDescription Récupérer la liste des commentaires d'une application donnée avec une limite.
*
* @apiParam {Number} idApp ID de l'application
* @apiParam {Number} limit Limite au nombre de commentaires retournés
*
* @apiSuccess (Succès) {Boolean} Error Retourne "false" en cas de réussite
* @apiSuccess (Succès) {Number} Code Code d'erreur (1 = Aucune erreur détectée)
* @apiSuccess (Succès) {Object[]} Comments Liste des commentaires
...
/**
* @api {delete} /comment/:idApp/:idComment Supprimer un commentaire
* @apiVersion 1.0.0
